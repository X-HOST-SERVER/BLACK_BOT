let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    await conn.sendMessage(m.chat, { video: { url: dir[Math.floor(Math.random() * dir.length)] }, caption: `*⊏─๋︩︪─๋︩︪─๋︩︪─๋︩︪─═͜⊐❪🐉❫⊏═─๋︩︪─๋︩︪─๋︩︪─๋︩︪─๋︩︪─⊐*\n*｢🐉｣⇇تـفـضـل طـلـبـك*\n*⊏─๋︩︪─๋︩︪─๋︩︪─๋︩︪─═͜⊐❪🐉❫⊏═─๋︩︪─๋︩︪─๋︩︪─๋︩︪─๋︩︪─⊐*` }, { quoted: m })
}
